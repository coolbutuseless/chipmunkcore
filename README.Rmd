...
best to use the functionality available through the simple [R6](https://r6.r-lib.org/) class provided - `Chipmunk`
...
**Read the online documentation [here](https://coolbutuseless.github.io/package/chipmunkcore)**
...
If you know how to install the [Chipmunk2d C library](http://chipmunk-physics.net/) on other systems, and subsequently compile
...
* [Basic Circles](https://coolbutuseless.github.io/package/chipmunkcore/articles/basic.html)
* [Basic Boxes](https://coolbutuseless.github.io/package/chipmunkcore/articles/basic-boxes.html)
* [Galton board](https://coolbutuseless.github.io/package/chipmunkcore/articles/galton.html)
